  ...
  execute(message, args, botVer) {
    ...
    if (!op) {
      message.channel.send(
        'You need to specify the operation and the operands.\nAvailable Operations:\n sum\n res\n div\n multi\n pow\n root',
      );
    } else {
      if (op === 'add') {
        if (!args[1] || !args[2]) {
          ...
          const SumAnswer = new Discord.MessageEmbed()
            ...
            .setThumbnail(
              'https://raw.githubusercontent.com/stationaryStation/StationBot/Next/Embeds/Bot%20Math%20-%20%20Plus.png',
            );
        ...
        if (!args[1] || !args[2]) {
          ...
          const SubAnswer = new Discord.MessageEmbed()
            ...
            .setDescription(`Your Answer is: ${ans}`)
            .setThumbnail(
              'https://raw.githubusercontent.com/stationaryStation/StationBot/Next/Embeds/Bot%20Math%20-%20%20Minus.png',
            );
        ...
        if (!args[1] || !args[2]) {
          ...
          const MultiAnswer = new Discord.MessageEmbed()
            ...
            .setDescription(`Your Answer is: ${ans}`)
            .setThumbnail(
              'https://raw.githubusercontent.com/stationaryStation/StationBot/Next/Embeds/Bot%20Math%20-%20%20Multi.png',
            );
        ...
        if (!args[1] || !args[2]) {
          ...
          const DivAnswer = new Discord.MessageEmbed()
            ...
            .setDescription(`Your Answer is: ${ans}`)
            .setThumbnail(
              'https://raw.githubusercontent.com/stationaryStation/StationBot/Next/Embeds/Bot%20Math%20-%20%20Div.png',
            );
