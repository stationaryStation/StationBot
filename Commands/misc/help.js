...
module.exports = {
  ...
  execute(message, args) {
      ...
      return (
        message.author
          ...
          .then(() => {
            ...
            message.reply(
              "I've sent you a direct message with all my commands!",
            );
          })
          ...
          .catch((error) => {
            ...
            message.reply(
              "it seems like I can't send a direct message to you! Do you have DMs disabled?",
            );
          })
      );
    }
    ...
    if (command.dev)
      data.push('*Developer command intended for developers*');
