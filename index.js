...
client.on("message", function (message) {
    if (message.author.bot) return;
    if (!message.content.startsWith(altPrefix)) return;
    ...
    if (command === "help") {
        const cmd = message.content.replace(`${altPrefix}help`,'').split(' ').pop().trim();
        if (cmd === "kick" ) {
            message.channel.send(`${altPrefix}kick <username>\nUsage: Kicks the user that you mentioned. `);
        } else if (cmd ==="ping" ) {
            message.channel.send(`${altPrefix}ping\nUsage: The bot replies to you with your current ping.`);
        } else if (cmd === "shutdown") {
            message.channel.send(`${altPrefix}shutdown\nUsage: Shutdowns the bot.\n Requirements: Be the dev`);
        } else if (cmd === "restart") {
            message.channel.send(`${altPrefix}restart\nUsage: Restarts the bot`);
        } else if (cmd === "help") {
            message.channel.send(`${altPrefix}help <command>\nUsage: Lists all current commands`);
        } else if (cmd === "ban") {
            message.channel.send(`${altPrefix}ban <UserID/User>\nUsage: Bans the user mentioned permanently\nRequirements: Be an admin`);
        } else if (cmd === "pootisfy") {
            message.channel.send(`${altPrefix}pootisfy\n Usage: Changes your nickname to pootis\nRequirements: You need to not have the manage nicknames permission and the change nickname permission`);
        } else if (cmd === "changeusernick") {
            message.channel.send(`${altPrefix}changeusernick <user> <nick>\nUsage: Changes the nickname of the user mentioned to whatever you like`);
        } else if (cmd === "changenick") {
            message.channel.send(`${altPrefix}changenick <nick>\nUsage: Changes your nickname to whatever you like\nRequirements: You need to not have nor the manage nicknames permission and the change nickname permission `);
        } else if (cmd === "boop"){
            message.channel.send(`${altPrefix}boop <user>\n Usage: Boops the mentioned user`);
        } else if (cmd === "devmedia") {
            message.channel.send(`${altPrefix}devmedia\nUsage: Lists stationaryStation's social media`);
        } else if (cmd === "") {
            message.reply(`Commands:\ndevmedia\nboop\nchangenick\nchangeusernick\npootisfy\nban\nhelp\nrestart\nshutdown\nping\nkick`);
        }
